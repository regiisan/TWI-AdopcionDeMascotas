...
VALUES
    (null, 'LUNA', 'Luna fue rescatada de las calles después de un accidente, es una perra muy cariñosa y tranquila que busca un hogar donde le den mucho amor.', false, 'images/mascotas/perro8.webp', 'sana, tiene todas las vacunas', 'social', 3, 'PERRO', 'HEMBRA', 'CHICO', 'BAJO', 'Aprobada',1),
    ...
    (null, 'VITO', 'Vito vivía en una granja y ahora busca una familia que le brinde mucho ejercicio y cariño, ya que es muy activo y juguetón.', false, 'images/mascotas/perro5.jpg', 'sano, con chip', 'activo', 5, 'PERRO', 'MACHO', 'GRANDE', 'ALTO', 'Aprobada',1),
    ...
    (null, 'SIMON', 'Simon fue rescatado de una casa donde lo maltrataban. Ahora es un perro calmado y fiel que solo quiere un hogar seguro.', false, 'images/mascotas/perro6.jpg', 'buena salud, sin alergias', 'calma', 6, 'PERRO', 'MACHO', 'GRANDE', 'BAJO', 'Aprobada',1),
    (null, 'KITTY', 'Kitty es una gata que fue encontrada en la calle, pequeña y cariñosa, ideal para vivir en departamentos o espacios pequeños.', false, 'images/mascotas/gato3.jpg', 'sana, todas las vacunas', 'social', 3, 'GATO', 'HEMBRA', 'CHICO', 'MEDIO', 'Aprobada',1),
    (null, 'ZEUS', 'Zeus es un perro inteligente que fue abandonado por su familia anterior. Busca un hogar donde pueda aprender y ser parte de la familia.', false, 'images/mascotas/perro4.jpg', 'salud estable', 'activo', 4, 'PERRO', 'MACHO', 'GRANDE', 'MEDIO', 'Aprobada',1),
    ...
    (null, 'BRUNO', 'Bruno es un perro que estuvo en un hogar temporal donde demostró ser muy juguetón y amigable con los niños.', false, 'images/mascotas/perro3.jpg', 'sano y vacunado', 'social', 2, 'PERRO', 'MACHO', 'MEDIANO', 'ALTO', 'Aprobada',1),
    (null, 'SIRA', 'Sira es una perra independiente que vivía en la calle, pero se adaptó rápido a la vida en hogares y busca un espacio tranquilo.', false, 'images/mascotas/perro2.jpg', 'salud perfecta', 'calma', 4, 'PERRO', 'HEMBRA', 'CHICO', 'BAJO', 'Aprobada',1),
    ...
    (null, 'ROCO', 'Roco fue víctima de maltrato en su juventud, lo que lo volvió reservado pero muy fiel a quien le brinda cariño. Necesita paciencia y amor.', false, 'images/mascotas/perro10.jfif', 'salud estable', 'activo', 2, 'PERRO', 'MACHO', 'GRANDE', 'MEDIO', 'Aprobada',1),
    (null, 'MORA', 'Mora es una gata juguetona y curiosa que se adapta fácilmente a nuevos entornos.', false, 'images/mascotas/gato6.webp', 'buena salud', 'social', 2, 'GATO', 'HEMBRA', 'MEDIANO', 'ALTO', 'Aprobada',1),
    (null, 'ALFONSO', 'Alfonso es un perro mayor, tranquilo y cariñoso que disfruta de los paseos lentos y la compañía familiar.', false, 'images/mascotas/perro14.jpg', 'salud estable para su edad', 'calma', 10, 'PERRO', 'MACHO', 'MEDIANO', 'BAJO', 'Aprobada',1),
    ...
    (null, 'NINA', 'Nina es una gata tranquila y dulce, le encanta estar cerca de las personas.', false, 'images/mascotas/gato8.jpg', 'buena salud', 'calma', 5, 'GATO', 'HEMBRA', 'MEDIANO', 'BAJO', 'Aprobada',1),
    ...
    (null, 'LUCAS', 'Lucas es un perro cariñoso y tranquilo que busca una familia que le dé mucho amor y paseos tranquilos.', false, 'images/mascotas/perro11.png', 'salud buena, vacunado', 'calma', 7, 'PERRO', 'MACHO', 'MEDIANO', 'BAJO', 'Aprobada',1),
    (null, 'MIMI', 'Mimi es una perra juguetona y sociable, ideal para hogares con niños o con otras mascotas.', false, 'images/mascotas/perro15.jpg', 'sana, todas las vacunas', 'social', 3, 'PERRO', 'HEMBRA', 'CHICO', 'MEDIO', 'Aprobada',1),
